package com.irrational.database.collection.impl

import com.irrational.database.collection.Collection
...
open class DocumentCollection<T : Document<T>>(private val collection: CoroutineCollection<T>) :
    Collection<T> {
